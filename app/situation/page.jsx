      ...
      <main className="mt-20">
        ...
        >          <div className="relative z-10">
            <p className="text-white text-lg mt-4">
              Situé à Riaz, au cœur de la Gruyère, cet immeuble bénéficie d'une localisation idéale. Vous trouverez à proximité des commerces et des transports publics facilitant vos déplacements dans toute la région.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-8 py-16">
          <h2 className="text-3xl font-bold mb-8">Localisation</h2>
